...
#create and fill table for team 1
...
foreach($result_teamName2 as $row) {
	$team2_table .= '<tr><td><b><u>' .$row['name']. '</u></b></td></tr>';
}
...
$team2_table .= '<tr><td><i> First Name </i></td><td><i> Last Name </i></td></tr>';
...
#echo both tables to matchView html
echo $team1_table;
echo $team2_table;
